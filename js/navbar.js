  ...
  <div class="container-fluid container-color">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <a class="log" href="/index.html">
        <img id="log" src="/recursos/log.png" alt="Link to homepage" ></a>
        <!--developer->
...
/*<li class="navio">
          <a class="nav-link" href="/html/carrito.html"> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#fff" class="bi bi-cart-plus" viewBox="0 0 16 16">
